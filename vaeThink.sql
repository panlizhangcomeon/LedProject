/*
 ...
 Source Server         : plz的数据库
 Source Server Type    : MariaDB
 Source Server Version : 50560
 Source Host           : 118.25.4.125:3306
 Source Schema         : vaeThink

 Target Server Type    : MariaDB
 Target Server Version : 50560
 File Encoding         : 65001

 Date: 18/03/2019 19:56:35
*/
...
-- ----------------------------
INSERT INTO `vae_admin` VALUES (1, 'root', 'aef3f95d0b3ea80014812d095e0ab017', 'tCmdJHGQ8SpUVca15KOi', 1, 1552909272, 1552909272, 0, 0, '', 0, 'Admin', NULL, '/themes/admin_themes/lib/vaeyo/img/thumb.png');
...
CREATE TABLE `vae_admin_menu`  (
  ...
  `update_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台菜单' ROW_FORMAT = Compact;
...
CREATE TABLE `vae_slide_info`  (
  ...
  `update_time` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '幻灯片详情' ROW_FORMAT = Compact;
